...
png("SimulationsM/post_asmk_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
...
png("SimulationsM/post_smk_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
...
png("SimulationsM/post_sim_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
...
# Plotting
png("SimulationsM/comp_sim_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
...
# Plotting
png("SimulationsM/comp_res_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
...
#         axis.line = element_line(colour = "black"))
#
# # png("SimulationsM/comp_cover_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
...
# Plotting
png("SimulationsM/comp_comp_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 3))
...
png("SimulationsM/comp_UCcomp_5_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
...
save.image(file = "SimulationsM/COMPARISON_5_500.RData")

# load("SimulationsM/COMPARISON_5_500.RData")
# res_5_500_M <- results
# rm(list = "results")
# gc()
# 
...
png("SimulationsM/post_asmk_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_dens_asmk, post_int_asmk)
dev.off()
...
png("SimulationsM/post_smk_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_dens_smk, post_int_smk)
dev.off()
...
png("SimulationsM/post_sim_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_int_asmk, post_int_smk)
dev.off()
...
# Plotting 
png("SimulationsM/comp_sim_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
iw1 <- as.image.SpatialGridDataFrame(surf.W1)
plot(crd, type="n", cex=0.5, xlim=xlim, axes=FALSE, ylab="Northing", xlab="Easting",
...
# Plotting 
png("SimulationsM/comp_res_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
...
# Plotting 
png("SimulationsM/comp_comp_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 3))
...
png("SimulationsM/comp_UCcomp_5_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(uc_Y1asmk, uc_Y2asmk, uc_Y1smk, uc_Y2smk)
dev.off()
...
rm(list = ls()[which(!(ls() %in% c("results")))])
save.image(file = "SimulationsM/COMPARISON_5_1000.RData")

# load("SimulationsM/COMPARISON_5_1000.RData")
...
png("SimulationsM/post_asmk_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_dens_asmk, post_int_asmk)
dev.off()
...
png("SimulationsM/post_smk_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_dens_smk, post_int_smk)
dev.off()
...
png("SimulationsM/post_sim_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_int_asmk, post_int_smk)
dev.off()
...
# Plotting 
png("SimulationsM/comp_sim_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
iw1 <- as.image.SpatialGridDataFrame(surf.W1)
plot(crd, type="n", cex=0.5, xlim=xlim, axes=FALSE, ylab="Northing", xlab="Easting",
...
# Plotting 
png("SimulationsM/comp_res_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
...
# Plotting 
png("SimulationsM/comp_comp_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 3))
...
png("SimulationsM/comp_UCcomp_10_500.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(uc_Y1asmk, uc_Y2asmk, uc_Y1smk, uc_Y2smk)
dev.off()
...
rm(list = ls()[which(!(ls() %in% c("results")))])
save.image(file = "SimulationsM/COMPARISON_10_500.RData")

# load("SimulationsM/COMPARISON_10_500.RData")
...
png("SimulationsM/post_asmk_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_dens_asmk, post_int_asmk)
dev.off()
...
png("SimulationsM/post_smk_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_dens_smk, post_int_smk)
dev.off()
...
png("SimulationsM/post_sim_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(post_int_asmk, post_int_smk)
dev.off()
...
# Plotting 
png("SimulationsM/comp_sim_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
iw1 <- as.image.SpatialGridDataFrame(surf.W1)
plot(crd, type="n", cex=0.5, xlim=xlim, axes=FALSE, ylab="Northing", xlab="Easting",
...
# Plotting 
png("SimulationsM/comp_res_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 2))
...
# Plotting 
png("SimulationsM/comp_comp_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
par(mfrow = c(2, 3))
...
png("SimulationsM/comp_UCcomp_10_1000.png", width = width, height = height, pointsize = pointsize, family = "sans")
# win.graph()
cowplot::plot_grid(uc_Y1asmk, uc_Y2asmk, uc_Y1smk, uc_Y2smk)
dev.off()
...
rm(list = ls()[which(!(ls() %in% c("results")))])
save.image(file = "SimulationsM/COMPARISON_10_1000.RData")

# load("SimulationsM/COMPARISON_10_1000.RData")
