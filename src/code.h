...
Rcpp::List r_pred_cpp(const Rcpp::List& data, const arma::mat& X_u, const arma::mat& d_u, const arma::mat& d_us, const Rcpp::List& hyperpar, const Rcpp::List& poster, const int& R = 1);
...
Rcpp::List r_pred_cpp_MvT(const Rcpp::List& data, const arma::mat& X_u, const arma::mat& d_u, const arma::mat& d_us, const Rcpp::List& hyperpar, const Rcpp::List& poster, const int& R = 1);
